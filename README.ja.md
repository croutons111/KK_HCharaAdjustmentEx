...
自動補正は、**女の子が相手や家具に触れる位置が決まっている体位**に掛かります。

| | 対象 |
|---|---|
| **対象** | 挿入（通常・アナル）／奉仕（口・胸・手・足）／家具を使う愛撫（机・椅子）／座り姿勢の自慰（椅子・机の角・ハードル）／レズのクンニと互い弄り／3P（女2人とも） |
| **対象外（バニラのまま）** | 立ち・シャワーの自慰／床・立ち・壁の愛撫／レズの具合わせ |

対象外の体位は**あえて何もしていません**。触れる位置が決まっていないため補正の基準がなく、ゲーム本体がすでに正しく処理しているので、動かすとかえって崩れます。

### そのほか

- 補正されるのは**女の子だけ**です。男は基準側として動かさないため、男の体格が標準の範囲外の場合は補正されません。
